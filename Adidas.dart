...
class _AdidasState extends State<Adidas> {
  ...
  final List<Map<String, dynamic>> _colors = [
    {'name': 'Blue', 'color': Color(0xff1E90FF)},
    {'name': 'White', 'color': Color(0xffF5F5F5)},
    {'name': 'Green', 'color': Color(0xff32CD32)},
  ];
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "High-performance running shoes engineered for speed and comfort. "
                "Features advanced cushioning technology and breathable mesh upper. "
                "Designed for runners who demand excellence. Lightweight construction with "
                "excellent grip and support. Your perfect running companion!",
                style: TextStyle(
                  fontSize: 15,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildFeatureRow(Icons.speed, "Boost Cushioning"),
